...
comment: true
language: '中文'
summary: "这篇文章主要介绍了五个有趣的GitHub项目，它们分别属于生活类和工具类，生活类项目包括“CookLikeHOC”，一个基于《老乡鸡菜品溯源报告》整理的食谱；工具类项目包括“PicSite”，一个在线图片展示网站、“CloudFlare-ImgBed”，一个开源文件托管解决方案和“Docker-Cloudflare”，一个Docker镜像代理服务，以及“Xget”，一个多资源加速代理服务，文章还。"
---
